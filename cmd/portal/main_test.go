...
func TestRequestCreatesPendingAccessWithoutGrant(t *testing.T) {
 ...
 res:=httptest.NewRecorder(); a.request(res,req)
...
func TestAdminRejectsOutsideGarageLAN(t *testing.T) {
 ...
 req:=httptest.NewRequest(http.MethodGet,"/admin",nil); req.RemoteAddr="192.168.60.9:1234"; req.SetBasicAuth("master","secret")
 res:=httptest.NewRecorder(); a.admin(res,req)
